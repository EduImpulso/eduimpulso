    ...
    return(
        <div className="container-fluid">
            ...
            <div className="row contaner-fluid d-flex align-items-center justify-content-around px-4 my-4">
                ...
                <h5 className="tituloCard my-auto d-flex align-items-center justify-content-center"> Saiba o que anda rolando de legal na educação do Brasil e do mundo! #sonoticiaboa </h5>
                <div className="mb-2 d-flex justify-content-around">
