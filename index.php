    ...
    <div class="container-fluid d-flex justify-content-center align-items-center">
        <div class="container-fluid row">
            <div class="m-auto p-5 col-12 col-md-12 col-lg-12 col-xl-5" style="border-radius: 30px; background-color: rgb(241, 228, 251, 0.8);">
                <h1 class="text-center pb-4" style="font-family: 'Rubik', sans-serif;">LOGIN</h1>
                <form>
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1" style="font-family: 'Rubik', sans-serif;">Senha</label>
                        ...
                        <a class="form-text text-muted" style="font-family: 'Rubik', sans-serif; font-size: 12px;">Cadastre-se aqui!</a>
                    </div>
